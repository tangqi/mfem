...
//
// Sample runs:  stokes -m ../data/square-disc.mesh
//               stokes -m ../data/star.mesh
//               stokes -m ../data/star.mesh 
//               stokes -m ../data/beam-tet.mesh
//               stokes -m ../data/beam-hex.mesh
//               stokes -m ../data/beam-hex.mesh
//               stokes -m ../data/escher.mesh
//               stokes -m ../data/fichera.mesh
//
// Description:  This example code solves a simple 2D/3D stokes problem
...
int main(int argc, char *argv[])
{
   ...
   //FiniteElementCollection *vel_fecoll(new H1_FECollection(order, dim));
   //FiniteElementCollection *pre_coll(new L2_FECollection(order-1, dim));
   ...
   //     Solve the linear system with MINRES.
